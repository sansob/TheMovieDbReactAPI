...
class moviepopular extends React.Component {
    ...
    componentDidMount() {
        axios.get(`https://api.themoviedb.org/3/discover/movie?api_key=16849afe437df1320762750a5efc0fc0&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1`)
            .then(res => {
        ...
        return (
            <div className="container">
                <div className="col-sm-12">
                    <h4 style={{marginBottom: 50}}>Popular Movies</h4>
